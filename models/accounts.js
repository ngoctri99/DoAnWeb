...
module.exports = {
    ...
    getAccount: async function(email, pass) {
        return db.load(`select account_email,account_id,account_name,account_level,account_image from ${TBL_POSTS} where account_email = '${email}' and account_password = '${pass}'`);
    },
